      ...
      <div className='projects' >
        <div className='row' >
          <div className='leftItem' >
            <img src='../../assets/eventUs-logo.jpg' alt='EventUs logo'/>
